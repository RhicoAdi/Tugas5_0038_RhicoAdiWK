...
class pelangganController {
    ...
    public function index() {
        ...
        include 'apps/views/pelanggan.php'; // Memuat view dengan data pengguna
    }
    ...
    public function tambah() {
        ...
        require_once 'apps/views/tambah_pelanggan.php';
    }
    ...
    public function edit($id_pelanggan) {
        ...
        require_once 'apps/views/edit_pelanggan.php';
    }
