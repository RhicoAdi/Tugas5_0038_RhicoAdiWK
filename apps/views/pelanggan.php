...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <a href="index.php?page=tambah_pelanggan" class="btn btn-info btn-sm bg-success mt-3 font-weight-bold<?php echo (isset($_GET['page']) && $_GET['page'] == 'tambah_barang') ? ' active' : ''; ?>" >Tambahkan Data</a>
